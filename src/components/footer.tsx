...
export default function Footer() {
  return (
    <footer className="p-5 md:p-20 sm:p-40">
      <div className="container mx-auto px-4 flex flex-col md:flex-row gap-10 justify-between items-center">
        {/* Logo Section */}
        ...
        <div className="flex  gap-5 justify-evenly items-center w-full">
          ...
          <div className="flex flex-col gap-5 items-center space-x-4 mt-4 md:mt-0 z-50">
            <h3 className="text-white font-NeueMachina-Bold text-[20px] sm:text-[30px]">
              <span>Contact </span>
